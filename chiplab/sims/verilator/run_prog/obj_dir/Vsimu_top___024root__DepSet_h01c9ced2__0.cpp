...
VL_INLINE_OPT void Vsimu_top___024root___sequent__TOP__1(Vsimu_top___024root* vlSelf) {
    ...
    vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
        ...
        if (vlSelf->simu_top__DOT__soc__DOT__cpu__DOT__btb_operate_en) {
            if (vlSelf->simu_top__DOT__soc__DOT__cpu__DOT__btb_add_entry) {
                ...
                vlSelf->__Vdlyvdim0__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__counter__v0 
                    = vlSelf->simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__add_entry_index;
            } else if ((1U & (~ (IData)(vlSelf->simu_top__DOT__soc__DOT__cpu__DOT__btb_delete_entry)))) {
    ...
    if (vlSelf->simu_top__DOT__soc__DOT__cpu__DOT__reset) {
        ...
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xfffffffeU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xfffffffdU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xfffffffbU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xfffffff7U & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xffffffefU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xffffffdfU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xffffffbfU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xffffff7fU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xfffffeffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xfffffdffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xfffffbffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xfffff7ffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xffffefffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xffffdfffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xffffbfffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xffff7fffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xfffeffffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xfffdffffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xfffbffffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xfff7ffffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xffefffffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xffdfffffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xffbfffffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xff7fffffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xfeffffffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xfdffffffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xfbffffffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xf7ffffffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xefffffffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xdfffffffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0xbfffffffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
        vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd 
            = (0x7fffffffU & vlSelf->__Vdly__simu_top__DOT__soc__DOT__cpu__DOT__btb__DOT__match_rd);
